...
export interface InitOutput {
  ...
  readonly __wasm_bindgen_func_elem_12758: (a: number, b: number, c: number) => void;
  readonly __wasm_bindgen_func_elem_12755: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_12768: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_107045: (a: number, b: number, c: number) => void;
  readonly __wasm_bindgen_func_elem_107043: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_12760: (a: number, b: number, c: number, d: number) => void;
  readonly __wasm_bindgen_func_elem_2972: (a: number, b: number, c: number) => void;
  readonly __wasm_bindgen_func_elem_1604: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_107099: (a: number, b: number, c: number, d: number) => void;
